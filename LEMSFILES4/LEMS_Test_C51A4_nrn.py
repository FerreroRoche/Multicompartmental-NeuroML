...
Components:
    ...
    C51A (Type: cell)
    iclamp0 (Type: pulseGenerator:  delay=0.05 (SI time) duration=0.25 (SI time) amplitude=-8.000000000000001E-10 (SI current))
    iclamp1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=0.25 (SI time) amplitude=-8.000000000000001E-10 (SI current))
