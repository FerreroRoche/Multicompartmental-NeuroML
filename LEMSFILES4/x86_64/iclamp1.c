...
#define nrn_init _nrn_init__iclamp1
#define _nrn_initial _nrn_initial__iclamp1
#define nrn_cur _nrn_cur__iclamp1
#define _nrn_current _nrn_current__iclamp1
#define nrn_jacob _nrn_jacob__iclamp1
#define nrn_state _nrn_state__iclamp1
#define _net_receive _net_receive__iclamp1 
#define rates rates__iclamp1 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 iclamp1 /home/jovyan/work/NeuroML_Examples/Rocher/LEMSFILES4/x86_64/iclamp1.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=iclamp1 type=pulseGenerator)";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jovyan/work/NeuroML_Examples/Rocher/LEMSFILES4/iclamp1.mod";
static const char* nmodl_file_text = 
