...
Components:
    ...
    C51A (Type: cell)
    iclamp0 (Type: pulseGenerator:  delay=0.05 (SI time) duration=0.25 (SI time) amplitude=0.0 (SI current))
    iclamp1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=0.25 (SI time) amplitude=0.0 (SI current))
