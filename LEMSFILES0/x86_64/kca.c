...
#define z_forwardRate_TIME_SCALE _p[3]
#define z_forwardRate_CONC_SCALE _p[4]
#define z_reverseRate_TIME_SCALE _p[5]
#define gion _p[6]
#define z_forwardRate_ca_norm _p[7]
#define z_forwardRate_r _p[8]
#define z_reverseRate_r _p[9]
#define z_rateScale _p[10]
#define z_alpha _p[11]
#define z_beta _p[12]
#define z_fcond _p[13]
#define z_inf _p[14]
#define z_tau _p[15]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "gmax_kca", "S/cm2",
 "conductance_kca", "uS",
 "z_forwardRate_TIME_SCALE_kca", "ms",
 "z_forwardRate_CONC_SCALE_kca", "mM",
 "z_reverseRate_TIME_SCALE_kca", "ms",
 "gion_kca", "S/cm2",
 "z_forwardRate_r_kca", "kHz",
 "z_reverseRate_r_kca", "kHz",
 "z_alpha_kca", "kHz",
 "z_beta_kca", "kHz",
 "z_tau_kca", "ms",
 "g_kca", "uS",
...
"kca",
 ...
 "conductance_kca",
 "z_instances_kca",
 "z_forwardRate_TIME_SCALE_kca",
 "z_forwardRate_CONC_SCALE_kca",
 "z_reverseRate_TIME_SCALE_kca",
 0,
 "gion_kca",
 "z_forwardRate_ca_norm_kca",
 "z_forwardRate_r_kca",
 "z_reverseRate_r_kca",
 "z_rateScale_kca",
 "z_alpha_kca",
...
static void nrn_alloc(Prop* _prop) {
	...
	double *_p; Datum *_ppvar;
 	...
 	conductance = 1e-05;
 	z_instances = 1;
 	z_forwardRate_TIME_SCALE = 1;
 	z_forwardRate_CONC_SCALE = 1;
 	z_reverseRate_TIME_SCALE = 1;
 	_prop->param = _p;
 	_prop->param_size = 30;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kca /home/jovyan/work/NeuroML_Examples/Rocher/LEMSFILES0/x86_64/kca.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=kca type=ionChannelHH)";
...
static int  rates ( _threadargsproto_ ) {
   double _lcaConc ;
 _lcaConc = cai ;
   z_forwardRate_ca_norm = 0.00002 * _lcaConc / z_forwardRate_CONC_SCALE ;
   if ( z_forwardRate_ca_norm > 0.01 ) {
     z_forwardRate_r = 0.01 / z_forwardRate_TIME_SCALE ;
     }
   else if ( z_forwardRate_ca_norm <= 0.01 ) {
     z_forwardRate_r = z_forwardRate_ca_norm / z_forwardRate_TIME_SCALE ;
     }
   z_reverseRate_r = 0.015 / z_reverseRate_TIME_SCALE ;
   z_rateScale = 1.0 ;
   z_alpha = z_forwardRate_r ;
   z_beta = z_reverseRate_r ;
   z_fcond = pow( z_q , z_instances ) ;
   z_inf = z_alpha / ( z_alpha + z_beta ) ;
   z_tau = 1.0 / ( ( z_alpha + z_beta ) * z_rateScale ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jovyan/work/NeuroML_Examples/Rocher/LEMSFILES0/kca.mod";
static const char* nmodl_file_text = 
