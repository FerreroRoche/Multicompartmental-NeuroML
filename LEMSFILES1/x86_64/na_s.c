...
#define nrn_init _nrn_init__na_s
#define _nrn_initial _nrn_initial__na_s
#define nrn_cur _nrn_cur__na_s
#define _nrn_current _nrn_current__na_s
#define nrn_jacob _nrn_jacob__na_s
#define nrn_state _nrn_state__na_s
#define _net_receive _net_receive__na_s 
#define rates rates__na_s 
#define states states__na_s 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_na_s", _hoc_setdata,
 "rates_na_s", _hoc_rates,
 0, 0
};
 ...
 "conductance_na_s", "uS",
 "m_SEC_na_s", "ms",
 "m_steadyState_midpoint_na_s", "mV",
 "m_steadyState_scale_na_s", "mV",
 "h_timeCourse_tau_na_s", "ms",
 "h_timeCourse_midpoint_na_s", "mV",
 "h_timeCourse_scale_na_s", "mV",
 "h_steadyState_midpoint_na_s", "mV",
 "h_steadyState_scale_na_s", "mV",
 "gion_na_s", "S/cm2",
 "m_tau_na_s", "ms",
 "h_timeCourse_t_na_s", "ms",
 "h_tauUnscaled_na_s", "ms",
 "h_tau_na_s", "ms",
 "g_na_s", "uS",
 0,0
};
...
"na_s",
 ...
 "m_instances_na_s",
 "m_SEC_na_s",
 "m_steadyState_rate_na_s",
 "m_steadyState_midpoint_na_s",
 "m_steadyState_scale_na_s",
 "h_instances_na_s",
 "h_timeCourse_tau_na_s",
 "h_timeCourse_midpoint_na_s",
 "h_timeCourse_scale_na_s",
 "h_steadyState_rate_na_s",
 "h_steadyState_midpoint_na_s",
 "h_steadyState_scale_na_s",
 0,
 "gion_na_s",
 "m_steadyState_x_na_s",
 "m_inf_na_s",
 "m_tau_na_s",
 "m_q_na_s",
 "m_fcond_na_s",
 "h_timeCourse_t_na_s",
 "h_steadyState_x_na_s",
 "h_rateScale_na_s",
 "h_fcond_na_s",
 "h_inf_na_s",
 "h_tauUnscaled_na_s",
 "h_tau_na_s",
 "conductanceScale_na_s",
 "fopen0_na_s",
 "fopen_na_s",
 "g_na_s",
 0,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 na_s /home/jovyan/work/NeuroML_Examples/Rocher/LEMSFILES1/x86_64/na_s.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=na_s type=ionChannelHH)";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jovyan/work/NeuroML_Examples/Rocher/LEMSFILES1/na_s.mod";
static const char* nmodl_file_text = 
