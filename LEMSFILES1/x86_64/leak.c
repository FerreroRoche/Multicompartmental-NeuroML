...
#define fopen _p[3]
#define g _p[4]
#define temperature _p[5]
#define eleak _p[6]
#define ileak _p[7]
#define v _p[8]
#define _g _p[9]
#define _ion_ileak	*_ppvar[0]._pval
#define _ion_dileakdv	*_ppvar[1]._pval
...
static void nrn_alloc(Prop* _prop) {
 ...
 prop_ion = need_memb(_leak_sym);
 	_ppvar[0]._pval = &prop_ion->param[3]; /* ileak */
 	_ppvar[1]._pval = &prop_ion->param[4]; /* _ion_dileakdv */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "leak_ion");
 	...
 	ivoc_help("help ?1 leak /home/jovyan/work/NeuroML_Examples/Rocher/LEMSFILES1/x86_64/leak.mod\n");
...
static void _hoc_rates(void) {
 ...
 static void _update_ion_pointer(Datum* _ppvar) {
   nrn_update_ion_pointer(_leak_sym, _ppvar, 0, 3);
   nrn_update_ion_pointer(_leak_sym, _ppvar, 1, 4);
 }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jovyan/work/NeuroML_Examples/Rocher/LEMSFILES1/leak.mod";
static const char* nmodl_file_text = 
