...
#define n_timeCourse_TIME_SCALE _p[3]
#define n_timeCourse_VOLT_SCALE _p[4]
#define n_steadyState_rate _p[5]
#define n_steadyState_midpoint _p[6]
#define n_steadyState_scale _p[7]
#define gion _p[8]
#define n_timeCourse_V _p[9]
#define n_timeCourse_t _p[10]
#define n_steadyState_x _p[11]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "n_steadyState_midpoint_kdr", "mV",
 "n_steadyState_scale_kdr", "mV",
 "gion_kdr", "S/cm2",
...
"kdr",
 ...
 "n_steadyState_rate_kdr",
 "n_steadyState_midpoint_kdr",
 "n_steadyState_scale_kdr",
 0,
 "gion_kdr",
 "n_timeCourse_V_kdr",
 "n_timeCourse_t_kdr",
...
static void nrn_alloc(Prop* _prop) {
	...
	double *_p; Datum *_ppvar;
 	...
 	n_steadyState_midpoint = -3;
 	n_steadyState_scale = 10;
 	_prop->param = _p;
 	_prop->param_size = 29;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdr /home/jovyan/work/NeuroML_Examples/Rocher/LEMSFILES1/x86_64/kdr.mod\n");
...
static int  rates ( _threadargsproto_ ) {
   ...
   n_timeCourse_t = ( 5.0 + ( 47.0 * exp ( - ( - 50.0 - n_timeCourse_V ) / 900.0 ) ) ) * n_timeCourse_TIME_SCALE ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jovyan/work/NeuroML_Examples/Rocher/LEMSFILES1/kdr.mod";
static const char* nmodl_file_text = 
