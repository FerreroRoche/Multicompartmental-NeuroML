...
Components:
    ...
    C51A (Type: cell)
    iclamp0 (Type: pulseGenerator:  delay=0.05 (SI time) duration=0.25 (SI time) amplitude=-2.0000000000000003E-10 (SI current))
    iclamp1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=0.25 (SI time) amplitude=-2.0000000000000003E-10 (SI current))
