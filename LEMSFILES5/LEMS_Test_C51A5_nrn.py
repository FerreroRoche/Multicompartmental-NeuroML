...
Components:
    ...
    C51A (Type: cell)
    iclamp0 (Type: pulseGenerator:  delay=0.05 (SI time) duration=0.05 (SI time) amplitude=0.0 (SI current))
    iclamp1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=0.05 (SI time) amplitude=0.0 (SI current))
    network_of_C51A (Type: networkWithTemperature:  temperature=310.15 (SI temperature))
    Test (Type: Simulation:  length=1.0 (SI time) step=2.5E-5 (SI time))
...
if __name__ == '__main__':
    ...
    ns = NeuronSimulation(tstop=1000, dt=0.025, seed=12345)
